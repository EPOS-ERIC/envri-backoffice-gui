...
export type SoftwareApplication = {
   ...
   *
   * @example {"entityType":"PERSON or ORGANIZATION","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  author?: LinkedEntity[];
  /**
  ...
  citation?: string[];
  /**
   * This property refers to the Contact Point defined for the Software Application
   *
   * @example {"entityType":"CONTACTPOINT","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  contactPoint?: LinkedEntity[];
   ...
   * @example {"entityType":"PERSON or ORGANIZATION","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  contributor?: LinkedEntity[];
  /**
   * This property refers to a Person or Organization.
   *
   * @example {"entityType":"PERSON or ORGANIZATION","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  creator?: LinkedEntity[];
  /**
  ...
  identifier?: LinkedEntity[];
  /**
   * This property represents a input parameters of the Software Application.
   *
   * @example {"entityType":"PARAMETER","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  inputParameter?: LinkedEntity[];
  /**
   * This property contains the URL at which the application may be installed.
   *
   * @example https://urltoinstaller
   */
  installURL?: string;
  /**
   * AUTOGENERATED - InstanceId of the previous version of the instance
  ...
  operation?: string;
  /**
   * This property represents a output parameters of the Software Application.
   *
   * @example {"entityType":"PARAMETER","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  outputParameter?: LinkedEntity[];
  parameter?: LinkedEntity[];
  ...
  publisher?: LinkedEntity[];
  /**
   * It represents the link to OPERATION Epos resource
   *
   * @example {"entityType":"OPERATION","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  relatedOperation?: LinkedEntity[];
  /**
...
export type SoftwareSourceCode = {
   ...
   *
   * @example https://repository/name
   */
  codeRepository?: string;
  /**
   * This property refers to the Contact Point (i.e. Role) defined for the Software Source Code
   *
   * @example {"entityType":"CONTACTPOINT","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  contactPoint?: LinkedEntity[];
   ...
   *
   * @example https://licenseurl
   */
  licenseURL?: string;
  /**
   * TThis property refers to the web page URL which describes the Software.
   *
   * @example https://pageurl
   */
  mainEntityofPage?: string;
  /**
   * This property refers to a Person or Organization.
  ...
  publisher?: LinkedEntity[];
  /**
   * It represents the link to another Epos resource Software Application
   *
   * @example {"entityType":"SOFTWAREAPPLICATION","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  relation?: LinkedEntity[];
  /**
...
export type WebService = {
   ...
   * @example {"entityType":"ANY ENTITY","instanceId":"an UUID","metaId":"an UUID","uid":"an UUID"}
   */
  webserviceRelation?: LinkedEntity[];
};
...
export type RoutesDistributionInfo = {
  instance_id?: string;
  relations?: RoutesPluginWithRelationDetails[];
};
...
export type RoutesPluginWithRelationDetails = {
  plugin?: ModelPlugin;
  relation?: ModelPluginRelation;
};
