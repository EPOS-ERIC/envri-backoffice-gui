...
import { LinkedEntity, ContactPoint, SoftwareSourceCode } from 'generated/backofficeSchemas';
...
@Component({
  selector: 'app-contact-point-search-sourceCode',
  templateUrl: './contact-point-search-sourceCode.component.html',
  styleUrl: './contact-point-search-sourceCode.component.scss',
})
export class ContactPointSearchSourceCodeComponent extends WithSubscription implements OnInit {
  ...
  public handleAddContactPoint(): void {
    ...
    activeSoftwareSourceCode.contactPoint = updatedContactPoints;
    this.entityExecutionService.setActiveSoftwareSourceCode(activeSoftwareSourceCode);
