...
export class PutAddress extends Endpoint<AddressDataSource, Address, AddressDataSource> {
  ...
  protected callLive(body: Address): Promise<AddressDataSource> {
    ...
    const callResponsePromise = this.apiCaller.doCall(['address'], RequestMethod.PUT, undefined, body, headers);
